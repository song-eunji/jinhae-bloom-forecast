      ...
      ...[
        ...
        mkTable(
          ...
          [
            ...
            ["2023", "3/25~4/3", "3/22~3/31", "+3일", "적중"],
            ["2024", "3/22~3/31", "3/26~4/4", "-4일", "적중"],
            ["2025", "3/29~4/6", "3/28~4/6", "+1일", "적중"],
            ["2026", "3/27~4/5", "3/25~4/3", "+2일", "적중"],
          ],
          [2600, 2600, 2600, 2000, 2000]
        ),
        p(""),
        p("2019년의 경우 모델 기준으로는 실제보다 축제를 10일 앞당겼어야 이상적이었으며, 실제 축제기간과 모델 권장기간이 단 하루도 겹치지 않았다(0일 중첩). 반면 2023~2026년에는 시작일 차이가 -4일~+3일(절대값 평균 약 2.5일) 수준으로 좁혀졌고, 실제 축제기간과 모델 권장기간이 매년 6~9일씩 겹쳐 정성적 판단만으로도 상당히 근접한 결정을 내려왔음을 확인할 수 있다. 다만 이 근접도를 매년 안정적으로 재현하려면 정량 모델의 보조가 필요하다."),
...
Packer.toBuffer(doc).then((buf) => {
  fs.writeFileSync("진해벚꽃_개화예측_분석보고서_v9.docx", buf);
  console.log("written");
});
